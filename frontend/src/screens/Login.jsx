    ...
    <div className={`relative min-h-screen transition-colors duration-500 font-sans flex flex-col justify-between overflow-hidden ${
          ...
          <div className={`w-full max-w-[440px] rounded-3xl border p-8 shadow-2xl backdrop-blur-xl transition-all ${
            ...
            <div className="text-center mb-6">
              ...
              <p className={`text-xs mt-1 ${isLight ? 'text-slate-500' : 'text-slate-400'}`}>
                Log in to continue to CodeSmith
              </p>
            </div>
            ...
            <form onSubmit={submitHandler} className="space-y-4">
              ...
              <div className="flex items-center justify-between text-xs pt-1">
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  />
                  <span className={isLight ? 'text-slate-600' : 'text-slate-400'}>Remember me</span>
                </label>
              ...
              <button
                type="submit"
                className="w-full py-3 px-4 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-semibold text-xs flex items-center justify-center gap-2 shadow-lg shadow-blue-500/30 transition-all hover:scale-[1.01] active:scale-[0.99]"
              >
      ...
      <footer className={`w-full py-4 px-6 lg:px-12 border-t flex flex-wrap items-center justify-between gap-4 text-xs ${
        ...
        <div className="flex items-center gap-2">
          <i className="ri-[#0B1120] ri-shield-check-line text-blue-600 text-sm"></i>
